        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PluginType = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PluginConfigurations_Integrations_IntegrationId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SyncJobs_Integrations_SourceIntegrationId",
                        column: x => x.SourceIntegrationId,
                        principalTable: "Integrations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SyncJobs_Integrations_TargetIntegrationId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SyncHistories_SyncJobs_SyncJobId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Integrations_PluginType",
                table: "Integrations",
                column: "PluginType");

            migrationBuilder.CreateIndex(
                name: "IX_PluginConfigurations_IntegrationId",
                table: "PluginConfigurations",
                column: "IntegrationId");

            migrationBuilder.CreateIndex(
                name: "IX_SyncHistories_SyncJobId",
                table: "SyncHistories",
                column: "SyncJobId");

            migrationBuilder.CreateIndex(
                name: "IX_SyncJobs_SourceIntegrationId",
                table: "SyncJobs",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SyncJobs_TargetIntegrationId",
                table: "SyncJobs",
